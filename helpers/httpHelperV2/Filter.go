...
//
// CreateOrder func
func (i *HTTPHelper) CreateOrder(query *bun.SelectQuery, sortModels SortModels, defaultSort []string) {
	if len(sortModels) != 0 {
...
// CreateFilter func
func (i *HTTPHelper) CreateFilter(query *bun.SelectQuery, filterModels FilterModels) {
