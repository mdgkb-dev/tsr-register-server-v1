...
// func (items ResearchQueryGroupQuestions) writeXlsxHeader(xl *writers.XlsxHelper) {
// 	for i := range items {
// 		items[i].writeXlsxHeader(xl)
// 	}
// }

// func (item *ResearchQueryGroupQuestion) writeXlsxHeader(xl *writers.XlsxHelper) {
...
// func (items ResearchQueryGroupQuestions) writeXlsxData(xl *writers.XlsxHelper, g *ResearchQueryGroup, result *ResearchResult) {
// 	for i := range items {
// 		items[i].writeXlsxData(xl, g, i, result)
// 	}
// }

// func (item *ResearchQueryGroupQuestion) writeXlsxData(xl *writers.XlsxHelper, g *ResearchQueryGroup, _ int, result *ResearchResult) {
// 	if item.EveryRadioSet {
// 		if item.Question.ValueType.IsSet() {
...
// func (items ResearchQueryGroupQuestions) writeAggregates(xl *writers.XlsxHelper) {
// 	for i := range items {
// 		items[i].writeAggregates(xl)
// 	}
// }

// func (item *ResearchQueryGroupQuestion) writeAggregates(xl *writers.XlsxHelper) {
// 	//if item.EveryRadioSet {
