...
UPDATE public.answer_variants SET item_order = 1 WHERE id = '6a67752d-361a-41bc-92a6-5903341db65d';
 ...
 INSERT INTO public.answer_variants (id, name, item_order, question_id, score, show_more_questions) VALUES ('6a5c57b6-9c77-49b2-b5e6-6315f800c035', 'Спинраза (МНН нусинерсен)', 0, '5d3b9a8a-9750-4caf-a0bf-7bbc0047400c', null, false);
 INSERT INTO public.answer_variants (id, name, item_order, question_id, score, show_more_questions) VALUES ('2abbbc2e-15bf-4f7d-84a2-aa03c487830b', 'Эврисди (МНН рисдиплам)', 2, '5d3b9a8a-9750-4caf-a0bf-7bbc0047400c', null, false);
 INSERT INTO public.answer_variants (id, name, item_order, question_id, score, show_more_questions) VALUES ('957af688-901e-4b5a-b1da-40c87f72e32d', 'Не получал', 3, '5d3b9a8a-9750-4caf-a0bf-7bbc0047400c', null, false);
 INSERT INTO public.answer_variants (id, name, item_order, question_id, score, show_more_questions) VALUES ('2839eccd-5b99-4824-8884-1ad2a99c9bcf', 'Золгенсма (МНН онасемноген абепарвовек)', 1, '5d3b9a8a-9750-4caf-a0bf-7bbc0047400c', null, false);
 INSERT INTO public.answer_variants (id, name, item_order, question_id, score, show_more_questions) VALUES ('9041d73b-644f-4f94-b211-823942da67c3', 'Другое', 4, '5d3b9a8a-9750-4caf-a0bf-7bbc0047400c', null, false);